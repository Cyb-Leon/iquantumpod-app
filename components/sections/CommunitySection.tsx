...
const testimonials: Testimonial[] = [
  {
    quote: "Finally, a podcast that feels like a real conversation, not a performance.",
    author: "Maya",
    location: "Brooklyn",
  },
  {
  ...
  {
    quote: "This is what media should be—authentic, inclusive, and community-driven.",
    author: "Aisha",
    location: "Oakland",
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-amber-500/10 to-yellow-600/10 border border-amber-500/30 rounded-2xl p-8 sm:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button className="bg-amber-500 hover:bg-amber-600 text-black font-semibold h-12 px-8">
              Submit a Topic
            </Button>
            <Button
              variant="outline"
              className="border-amber-500 text-amber-500 hover:bg-amber-500 hover:text-black h-12 px-8 bg-transparent"
            >
              Become a Guest
            </Button>
          </div>
